...
def listar_vendedores_ativos():
    ...
    if vendedores:
        for vendedor in vendedores:
            print(f"ID: {vendedor[0]}, Nome: {vendedor[1]}, Email: {vendedor[2]}, Cidade: {vendedor[3]}, Telefone: {vendedor[4]}")
    else:
...
def listar_clientes():
    ...
    if clientes:
        for cliente in clientes:
            print(f"ID: {cliente[0]}, Nome: {cliente[1]}, Email: {cliente[2]}, Cidade: {cliente[3]}, Telefone: {cliente[4]}")
    else:
